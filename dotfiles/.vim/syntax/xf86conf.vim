...
" Notes: Since underscores or even spaces may be inserted at arbitrary
"            positions in most keywords we give up precise highlighting.
"            Use "SyncOnGreen" instead of "__s yn con gr_e_e_n".
"        The list of options is highly incomplete, feel free to send me more.
...
" use XFree86 4.x syntax by default
...
" (DecimalNumber and Frequency are tweaked to accept ranges like 50-90)
...
syn keyword xf86confKeyword Hskew HTimings InputDevice IOBase MemBase nextgroup=xf86confComment,xf86confValue
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""" }}}
" Synchronization {{{
" Don't sync on sections which may contain subsections
if b:xf86conf_xfree86_version >= 4
