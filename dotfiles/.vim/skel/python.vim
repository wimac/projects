""Python Settings
echo "Loading Python IDE Settings"
source ~/.vim/skel/hacking.vim

map <buffer> <F5> :w<CR>:!/usr/bin/env python % <CR>

au BufWritePost * if getline(1)=~"^#!/usr/bin/env*python" | silent !chmod a+x <afile> |endif
...
autocmd filetype python source ~/.vim/skel/pydoc.vim
