...
"   Version:	3
"
" It will display all the colors available under X.
" Since gvim is unable to display all the colors
" concurrently, the display will pause every two
" seconds for several pages.
"
" ---------------------------------------------------------------------
if !has("gui_running")
...
" Events:
au CursorHold * set lz|call CurHoldFix()|set nolz
let &updatetime= 1000
